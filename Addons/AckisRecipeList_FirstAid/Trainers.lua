...
function module:InitializeTrainers()
	...
	AddTrainer(16731, "Nus", 			Z.THE_EXODAR, 			39.0, 22.5, "Alliance")
	AddTrainer(17214, "Anchorite Fateema",		Z.AZUREMYST_ISLE, 		48.5, 51.8, "Alliance")
	AddTrainer(17424, "Anchorite Paetheus", 	Z.BLOODMYST_ISLE,		54.7, 54.0, "Alliance")
	AddTrainer(18990, "Burko", 			Z.HELLFIRE_PENINSULA,		22.4, 39.3, "Alliance")
	AddTrainer(18991, "Aresella", 			Z.HELLFIRE_PENINSULA,		26.3, 62.0, "Horde")
	AddTrainer(19184, "Mildred Fletcher", 		Z.SHATTRATH_CITY, 		66.5, 13.5, "Neutral")
	AddTrainer(19478, "Fera Palerunner", 		Z.BLADES_EDGE_MOUNTAINS,	54.0, 55.1, "Horde")
	...
	AddTrainer(28706, "Olisarra the Kind", 		Z.DALARAN_NORTHREND,		37.5, 36.7, "Neutral")
	...
	AddTrainer(33621, "First Aid", 			Z.SHATTRATH_CITY, 		43.6, 90.4, "Neutral")
	...
	AddTrainer(49879, "Doc Zapnozzle", 		Z.AZSHARA, 			57.1, 50.7, "Horde")
	AddTrainer(50574, "Amelia Atherton", 		Z.GILNEAS, 			36.8, 65.7, "Alliance")
	AddTrainer(56796, "Angela Leifeld", 		Z.STORMWIND_CITY, 		52.2, 45.4, "Alliance")
	AddTrainer(59077, "Apothecary Cheng", 		Z.KUN_LAI_SUMMIT, 		71.6, 92.8, "Neutral")
	AddTrainer(59619, "Mishka", 			Z.THE_JADE_FOREST, 		59.9, 86.3, "Alliance")
	...
	AddTrainer(76519, "Rott Bonefinger", 		Z.BLASTED_LANDS, 		72.2, 47.8, "Horde")
	...
	AddTrainer(93529, "Olisarra the Kind",		Z.DALARAN_BROKENISLES,		36.0, 37.6, "Neutral")
